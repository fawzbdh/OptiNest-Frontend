...
import { Box, Button, TextField, Drawer, Grid, Typography } from '@mui/material';
  ...
  return (
    <div style={{ height: 400, width: '100%' }}>
      <Box m="8px 0 0 0" width="100%" height="80vh">
        ...
        <Button onClick={handleAddUser} variant="contained" color="primary" style={{ marginBottom: '10px', marginTop: '50px' }}>
        ...
        >
          ...
          <Box p={2} width="100%">
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField label="Rôle" name="role" value={newUser.role} onChange={handleChange} fullWidth margin="normal" />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  label="mot de passe"
